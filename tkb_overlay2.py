#!/usr/bin/env python3
"""Build ADVENT.TSK with corrected ODL overlay structure."""
...
def main():
    print("=" * 60)
    print("Build ADVENT.TSK - Corrected Overlay Structure")
    print("=" * 60)
    ...
    # Corrected ODL structure:
    # .ROOT specifies the main module and overlay structure
    # Each overlay is defined with .FCTR
    odl_lines = [
        "10 OPEN 'DM1:[1,2]ADVENT.ODL' FOR OUTPUT AS FILE #1%",
        '20 T$=CHR$(9%)',
        # Root: main program, library, then overlays
        '30 PRINT #1%,T$;".ROOT DM1:[1,2]ADVENT-LIBR-*(OVLY)"',
        # Library (searched for undefined symbols)
        '40 PRINT #1%,"LIBR:";T$;".FCTR SY:[1,1]BP2OTS/LB"',
        # Overlay tree - each segment loads into same memory area
        '50 PRINT #1%,"OVLY:";T$;".FCTR *(A,B,C,D,E)"',
        # Each overlay segment
        '60 PRINT #1%,"A:";T$;".FCTR DM1:[1,2]ADVINI,DM1:[1,2]ADVOUT,DM1:[1,2]ADVNOR"',
        '70 PRINT #1%,"B:";T$;".FCTR DM1:[1,2]ADVCMD,DM1:[1,2]ADVODD,DM1:[1,2]ADVMSG"',
        '80 PRINT #1%,"C:";T$;".FCTR DM1:[1,2]ADVBYE,DM1:[1,2]ADVSHT,DM1:[1,2]ADVNPC"',
        '90 PRINT #1%,"D:";T$;".FCTR DM1:[1,2]ADVPUZ,DM1:[1,2]ADVDSP,DM1:[1,2]ADVFND"',
        '100 PRINT #1%,"E:";T$;".FCTR DM1:[1,2]ADVTDY"',
        '110 PRINT #1%,T$;".END"',
        '120 CLOSE #1%',
    ...
    # Run TKB with ODL - simpler command
    print("\n=== Running TKB ===")
    child.sendline('RUN $TKB')
    child.expect('TKB>', timeout=15)

    # TKB command: output=@indirect_file
