#!/usr/bin/env python3
"""Create single-user version of ADVINI and recompile the game."""
...
def main():
    ...
    # Create a modified ADVINI that uses _KB: instead of _KB11:
    # The key change is line 27: OPEN "_KB:" instead of OPEN "_KB11:"
    print("\n=== Create modified ADVINI.SUB ===")
    send_cmd(sock, 'DELETE/NOCONFIRM DM1:[1,2]ADVINI.SUB', wait=1)
    send_cmd(sock, 'CREATE DM1:[1,2]ADVINI.SUB', wait=1)

    # Modified source - uses _KB: for single-user mode
    lines = [
        '1\tSUB ADVINI',
    ...
    result = send_cmd(sock, 'BASIC/BP2 DM1:[1,2]ADVINI', wait=30)
