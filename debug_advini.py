#!/usr/bin/env python3
"""Debug ADVINI - print error to screen immediately."""
...
def main():
    ...
    # Create debug ADVINI that prints error to screen
    ...
    # Debug version - prints each step and error to screen
    lines = [
        '1\tSUB ADVINI &',
        ...
        '',
        '15\tPRINT "ADVINI: Setting up system..." &',
        ...
        '\\\tMMM$=J$',
        '',
        '40\tPRINT "ADVINI: Initialization complete!" &',
        '\\\tSUBEXIT',
        '',
