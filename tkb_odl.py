#!/usr/bin/env python3
"""Build ADVENT.TSK using existing ODL file on DM1."""
...
def main():
    print("=" * 60)
    print("Build ADVENT.TSK using ODL file")
    print("=" * 60)
    ...
    # Try format: output=@odlfile with explicit /FP switch
    # The ODL file already contains ADVENT as the main module
