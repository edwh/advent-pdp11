#!/usr/bin/env python3
"""Build ADVENT.TSK - fit all files in 3 continuation lines."""
...
def main():
    print("=" * 60)
    print("Build ADVENT.TSK - 3 Lines with Logical Name")
    print("=" * 60)
    ...
    # Run TKB with 3 lines only
    # Line 1: output + 5 files (ADVENT,ADVINI,ADVOUT,ADVNOR,ADVCMD) + continuation
    # Line 2: 5 files (ADVODD,ADVMSG,ADVBYE,ADVSHT,ADVNPC) + continuation
    # Line 3: 4 files (ADVPUZ,ADVDSP,ADVFND,ADVTDY) + library (no continuation)
    print("\n=== Running TKB (3 lines only) ===")
    ...
    # Line 3: 52 chars (no continuation)
