#!/usr/bin/env python3
"""Create truly single-user ADVINI - remove all multi-user messaging."""
...
def main():
    ...
    # Create single-user ADVINI - no message receiver registration
    print("\n=== Create single-user ADVINI.SUB ===")
    ...
    # Single-user version - removed:
    # - SYS(CHR$(6%)+CHR$(22%)...) message receiver registration
    # - SYS(CHR$(6%)+CHR$(-13%)...) CCL related
    # - SYS(CHR$(6%)+CHR$(-26%)...) message related
    # - SYS(CHR$(6%)+CHR$(7%)...) terminal mode (might need this)
    lines = [
        '1\tSUB ADVINI &',
        ...
        '\\\tCI$=CHR$(9%)',
        '',
        '! Open files - use _KB: for single user instead of _KB11:',
        '20\tOPEN "_KB:" AS FILE #1% &',
